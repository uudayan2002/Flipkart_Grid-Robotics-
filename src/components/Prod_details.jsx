          ...
          <h2>
            <AccordionButton>
              <Box as="span" flex="1" textAlign="left">
                <Box position="absolute" top="5px" right="10px" width="50px" height="50px" opacity={1} display="flex" alignItems="center" justifyContent="center" border="2px solid #EDF1D6" borderRadius="10px" color="#EDF1D6" fontSize="20px" fontWeight="bold" bg="#40513B">
                  A
                </Box>
                Maggi 70g
              </Box>
